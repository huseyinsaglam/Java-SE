...
public class Main {
    ...
    /*
    2 boyutlu arraylerle hafiza oyunu
    ...
    */
    ...
    public static void kayittanAl() {
        ...
        if (file.exists()) {
            ...
            System.out.print("Kaydedilmis bir oyununuz var. Kayittan devam etmek ister misiniz ? (yes ya da no)");
    ...
    public static void main(String[] args) {
        ...
        while (oyunBittiMi() == false) {
            ...
            oyunTahtasi();
            System.out.print("Cikis icin q'ya basin (yes ya da no)");
